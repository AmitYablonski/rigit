...
class SkinWorks():
    ...
    def generalSkinTools(self, mainLayout):
        ...
        cmds.button("Import Skin", h=20, w=110, ann="Open settings window", bgc=bColor2,
                    c="import mgear; mgear.maya.skin.importSkin()")
        cmds.button("Export Skin", h=20, w=110, ann="Open settings window", bgc=bColor,
        ...
        butW = 106
        cmds.button(label='Zero joint Orients', ann="Zero joint rotate and joint orient.", bgc=bColor2, w=butW,
                    c=gmt.zeroJntOrients)
        cmds.button(label='rotate to jnt Orient', ann="Transfer rotate values to joint orient", bgc=bColor2, w=butW,
                    c=gmt.rotateToJntOrient)
        cmds.button(label='jnt orient to rotate ', ann="Transfer joint orient to rotation", bgc=bColor, w=butW,
