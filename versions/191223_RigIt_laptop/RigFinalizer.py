...
class RigFinalizer:
            ...
            if 'ShowCnsControls' not in conn:
                ...
                if shp:
                    ...
                    if 'ShowCnsControls' not in conn:
                        ...
                        # todo make sure the cns attr is on local for characters and on global for props
        # feedback
        if cnsFixList:
            self.addLogHeader(field)
    ...
    def populateSteps(self, parLay):
        ...
        allFieldsDict = [
            ...
            ['nkSkinTools', 'nkSkinTools', 'nkSkinTools nodes found', True, True],
        ]
        ...
        self.fieldsDefault = {
            ...
            'nkSkinTools': 'Check for ngSkinTool nodes'
        }
        delButton = ['vray', 'guide', 'nkSkinTools']
