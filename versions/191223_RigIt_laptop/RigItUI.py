...
class RigItUI:
    ...
    def cleanupTools(self, parent="None"):
        ...
        cmds.button(l='LRC\ndebug', w=self.buttonW3, bgc=bColor2, h=self.buttonH+1,
    ...
    def funkyTools(self, parent="None"):
        ...
        cmds.iconTextButton(style='iconAndTextVertical', label='multi\nUV connect', image1=self.iconPath + "question.png",
                            w=self.buttonW4, ann="",
...
'''
    ...
    def openMultiUVConnect(*args):
        ...
        multiUVConnect.multiUVConnect()#scriptIt=True)
