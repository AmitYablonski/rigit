...
class UVtransMaster:
    ...
    def execTransObjToObj(self, *args):
        ...
        # transferring uv
        optLayS, chBoxS, optMenuS = self.mapsDict[self.widgets['sourceObj']]
        ...
        optLayD, chBoxD, optMenuD = self.mapsDict[self.widgets['destObj']]
