        ...
        for obj in sele:
            ...
            if '|' in shpName:
                ...
                if part[0]:
                    ...
                    # turn on ID
            try:
                print 'vray addAttributesFromGroup %s vray_objectID 1;' % objShp.name()
                mel.eval('vray addAttributesFromGroup %s vray_objectID 1;' % objShp.name())
            except:
                # todo print traceback
                mel.eval('vray addAttributesFromGroup %s vray_objectID 1;' % shpName)
            # set ID
