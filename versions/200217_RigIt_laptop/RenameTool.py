...
class RenameTool:
    ...
    def renameToolWin(self):
        ...
        self.widgets["padding_field"] = cmds.intSliderGrp(field=True, label='Padding', minValue=1, maxValue=10,
                                                          fieldMinValue=1, fieldMaxValue=30, w=300, columnWidth=[1, 70],
                                                          visible=False, h=19)
        self.widgets["startNum_field"] = cmds.intSliderGrp(field=True, label='Count Start', minValue=0,
                                                           fieldMinValue=0, w=300, columnWidth=[1, 70],
                                                           visible=False, h=19)
        ...
        pm.text('Rename Pre/Suffix by\nnum of chars at string\'s ends:')  # , al='left')
        cmds.separator(h=3)
        ...
        self.widgets["exAmt_field"] = cmds.intSliderGrp(field=True, label='amount', minValue=0, maxValue=5,
                                                        fieldMinValue=0, fieldMaxValue=99, columnWidth=[1, 55])
        cmds.separator(h=7)
    ...
    def renameChange(self, *args):
        ...
        if op == 4:
            ...
            cmds.intSliderGrp(self.widgets["startNum_field"], edit=True, visible=True)
            ...
            cmds.intSliderGrp(self.widgets["startNum_field"], edit=True, visible=False)
    ...
    def renameMethod(self, selection, line2, *args):
        ...
        startNum = pm.intSliderGrp(self.widgets["startNum_field"], q=True, value=True)
        if startNum and not padding:
            padding = 1
        if padding:
            i = startNum
            for sel in selection:
