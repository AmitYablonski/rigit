...
class RigItUI:
    ...
    def __init__(self, path=''):
        ...
        self.importFolders = ["RigItUI", "ScriptIt"]  # pipeline: for now: , "Guider"]
        self.rigItImports()
    ...
    def funkyTools(self, parent="None"):
        ...
        cmds.iconTextButton(style='iconAndTextVertical', label='Duplicator', image1="colorProfile.png",
    ...
    def snowballToolsFrame(self, parent='None'):
        ...
        cmds.iconTextButton(style='iconAndTextVertical', l='Finalizer\nFixer',
                            image1=self.iconPath + "mass_tools_icon_02.png",
                            ann="Opens Mass tools window - tools to help with mass repetitions.",
                            w=self.buttonW4, h=h + 10, c=self.openFinalizerFixer)
    ...
    @staticmethod
    def openFinalizerFixer(*args):
        import FinalizerFixer
        reload(FinalizerFixer)
        FinalizerFixer.FinalizerFixer(scriptIt=True)

    def openWinTest(self, *args):
        import RigItBasicWindow_adj
        reload(RigItBasicWindow_adj)
        RigItBasicWindow_adj.ToolName(scriptIt=True)
        # import WinTest
        # reload(WinTest)
