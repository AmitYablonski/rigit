        ...
        if assetType == 'set':
            ...
            for obj in setGrps:
                ...
                if amt > 0:
                    ...
                    error = []
                    if 'deform' in obj:
                        errors, badDeformObjs = self.deformCheck()
                    else:
                        errors, badTransformObjs = self.transformCheck()
                    if errors:
                        for obj in badDeformObjs:
                            self.widgets[field + '_items'].append(obj)
                        for obj in badTransformObjs:
                            self.widgets[field + '_items'].append(obj)
                        for error in errors:
    ...
    def deformCheck(self):
        ...
        for obj in deformObjs:
            ...
            if obj not in constraints:
                ...
                if not shps:
                    # todo if constraint or empty group etc - list it as bad
