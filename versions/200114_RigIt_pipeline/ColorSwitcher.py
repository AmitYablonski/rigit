...
class ColorSwitcher:
    def __init__(self):
        self.widgets = {}
        self.feedbackName = 'Color Switcher'
        topLay, mainLay = self.winBase('ColorSwitcher', self.feedbackName)
    ...
    def populateUI(self, mainLay):
        ...
        cmds.button(l='Ececute', h=28, c=self.execute)
    ...
    def getScrollSelection(self):
        ...
        if idx and tx:
            ...
            return False, False  # todo raise error?
